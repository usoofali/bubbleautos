...
<template>
    ...
    >
        <div v-if="title || $slots.header" class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 px-6 py-4.5 border-b border-slate-100 dark:border-slate-800/80">
            <slot name="header">
                <div>
            ...
            <div v-if="$slots.headerActions" class="flex flex-wrap items-center gap-2 shrink-0">
